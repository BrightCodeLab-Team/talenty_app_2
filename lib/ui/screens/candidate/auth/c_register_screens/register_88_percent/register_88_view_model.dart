...
class CandidateRegister88PercentViewModel extends BaseViewModel {
  ...
  UniversityModel88Percent?
  selectedUniversityModel; // <-- Changed to UniversityModel88Percent
  ...
  void selectUniversity(UniversityModel88Percent university, int index) {
    // <-- Changed to UniversityModel88Percent
  ...
  CandidateRegister88PercentViewModel() {
    // Corrected constructor name
    init();
  }

  List<UniversityModel88Percent> universityList = [
    // <-- Changed to UniversityModel88Percent
    UniversityModel88Percent(
  ...
  void updateFormValidity() {
    validateAllEntries(); // This method already sets isFormValid
    notifyListeners();
  }
...
class UniversityEntry {
  ...
  UniversityModel88Percent?
  selectedUniversity; // <-- Changed to UniversityModel88Percent
...
// This model should be in its own file or at least outside the ViewModel class
class UniversityModel88Percent {
  final String name;
